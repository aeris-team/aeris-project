"""
dashboard.py - Ground Station Dashboard (Raspberry Pi 5)
    ...
    def get_status(self) -> dict:
        ...
        with self.lock:
            ...
            return {
                ...
                # Raspberry Pi 5 device metadata
                ...
                # Raspberry Pi 5 hardware simulation telemetry
                **hw_simulator.snapshot(),
            }
...
<title>DRRM Ground Station — Raspberry Pi 5</title>
<style>
...
<div class="panel">
<h2>&#x1f4bb; Raspberry Pi 5 System Status</h2>
<div class="info-grid">
<div class="info-item"><div class="label">CPU Usage</div><div class="value cyan" id="simCpuUsage">--%</div></div>
<div class="info-item"><div class="label">RAM Usage</div><div class="value" id="simRamUsage">-- / --</div></div>
<div class="info-item"><div class="label">CPU Temp</div><div class="value yellow" id="simCpuTemp">-- &#xb0;C</div></div>
<div class="info-item"><div class="label">Uptime</div><div class="value" id="simUptime">--:--:--</div></div>
<div class="info-item"><div class="label">Camera</div><div class="value green" id="simCamera">--</div></div>
<div class="info-item"><div class="label">LoRa</div><div class="value yellow" id="simLoRa">--</div></div>
<div class="info-item"><div class="label">Python</div><div class="value green" id="simPython">--</div></div>
<div class="info-item"><div class="label">OpenCV</div><div class="value" id="simOpencv">--</div></div>
</div>
</div>
<div class="panel">
<h2>&#x2764; Vital Signs</h2>
...
document.getElementById('simCpuUsage').textContent=(d.cpu_usage_pct!=null?d.cpu_usage_pct+'%':'--');
document.getElementById('simRamUsage').textContent=(d.ram_used_gb!=null&&d.ram_total_gb!=null)?(d.ram_used_gb+' GB / '+d.ram_total_gb+' GB'):'-- / --';
document.getElementById('simCpuTemp').textContent=(d.cpu_temp_c!=null?d.cpu_temp_c+' \u00b0C':'-- \u00b0C');
document.getElementById('simUptime').textContent=d.uptime||'--:--:--';
document.getElementById('simCamera').textContent=d.camera_status||'--';
document.getElementById('simLoRa').textContent=d.lora_status||'--';
document.getElementById('simPython').textContent=d.python_runtime||'--';
document.getElementById('simOpencv').textContent=d.opencv_version||'--';
};
es.onerror=function(){};
</script>
</body>
    ...
    def generate():
        while True:
            ...
            if frame is not None:
                ...
                # Overlay label
                h, w = frame.shape[:2]
                cv2.putText(frame, "DRRM GROUND STATION — Raspberry Pi 5",
                            (10, h - 12),
