"""
main.py  (v7 — LoRa + Dashboard) - Raspberry Pi 4 Model B
=========================================================

Full prototype pipeline running on the Raspberry Pi 4 Model B:
...
Uses a USB camera connected to the Raspberry Pi 4 Model B via OpenCV
VideoCapture.
...
CAMERA_INDEX         = 0          # USB camera on the Raspberry Pi 4 Model B
INIT_WIN_W           = 640
INIT_WIN_H           = 360
...
def open_camera(index=CAMERA_INDEX):
    """Open the USB camera connected to the Raspberry Pi 4 Model B."""
...
def main():
    ...
    # ── Device information (Raspberry Pi 4 Model B) ───────────────────────
    ...
    # ── Detection window ────────────────────────────────────────────────────
    WIN = "Human Detection — DRRM Prototype (Raspberry Pi 4 Model B)"
