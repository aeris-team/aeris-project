"""
receiver.py - Simulated LoRa Receiver (Raspberry Pi 4 Model B)
...
Raspberry Pi 4 Model B) only requires replacing the socket layer while keeping
the packet storage and dashboard interface identical.
"""
